...
const projects = [
  ...
  {
    title: "TaskLink",
    award: "Lead Full-Stack Developer",
    description: "Responsive dashboard with dual-portal architecture. Scalable REST APIs with JWT auth, MongoDB aggregation pipelines, and Google Cloud Natural Language API integration for resume optimization.",
    tech: ["MERN Stack", "GCP", "WebSockets", "Railway"],
    github: "#",
    live: "https://tasklink-production.up.railway.app/landing",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {projects.map((project, index) => (
            ...
            >
              <SpotlightCard className="glass-panel rounded-2xl p-7 h-full flex flex-col group hover:border-blue-500/30 transition-colors duration-500">
                {/* Header */}
